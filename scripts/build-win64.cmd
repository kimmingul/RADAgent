...
call "%RSVARS%"
if "%BDS%"=="" goto nobds
msbuild "%~dp0..\src\RADAgent.dproj" /nologo /v:minimal /p:Config=Release /p:Platform=Win64
...
exit /b 1
:fail
echo [RADAgent] 실패한 명령: msbuild src\RADAgent.dproj /p:Config=Release /p:Platform=Win64
echo [RADAgent] BDS=%BDS%
exit /b 1