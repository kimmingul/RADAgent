...
call "%RSVARS%"
if "%BDS%"=="" goto nobds
msbuild "%~dp0..\src\DelphiAgent.dproj" /nologo /v:minimal /p:Config=Release /p:Platform=Win64
if errorlevel 1 goto fail
set "BPLDIR=%BDSCOMMONDIR%\Bpl\Win64"
...
exit /b 1
:fail
echo [DelphiAgent] 실패한 명령: msbuild src\DelphiAgent.dproj /p:Config=Release /p:Platform=Win64
echo [DelphiAgent] BDS=%BDS%
exit /b 1