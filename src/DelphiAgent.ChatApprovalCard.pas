unit DelphiAgent.ChatApprovalCard;

{ Approval asked inside the chat: a card with the change (line diff) and 승인/거부 buttons. The
...
uses
  ...
  DelphiAgent.ChatSession, DelphiAgent.LineDiff, DelphiAgent.DockKeeper;
...
begin
  ...
  try
    ...
    begin
      ...
      Obj.AddPair('summary', Format('삭제 %d줄, 추가 %d줄', [Removed, Added]));
    end;
