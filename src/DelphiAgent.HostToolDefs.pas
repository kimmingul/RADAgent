...
type
  TToolProfile = record
    ...
    Framework: string;
    HasForms: Boolean;
    { DelphiAgent plan mode: read-only rad.* tools plus rad.submit_plan. }
    PlanMode: Boolean;
  end;
  ...
  try
    ...
    begin
      ...
      Tools.AddElement(SchemaDef(ToolSubmitPlan,
        'Plan mode only: submit the finished plan. DelphiAgent writes it to docs\plans\<date>-<slug>.md ' +
