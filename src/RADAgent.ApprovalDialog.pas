...
begin
  ...
  try
    ...
    BtnCancel.Caption := Tr('approvaldialog.cancel');
    ...
    BtnApprove.Caption := Tr('approvaldialog.approve');
    ...
    try
      ...
      begin
        ...
        LblSummary.Caption := TrF('approvaldialog.linesAdded', [Length(AfterLines)]);
      ...
      begin
        ...
        LblSummary.Caption := TrF('approvaldialog.linesDiff', [RemovedCount, AddedCount]);
