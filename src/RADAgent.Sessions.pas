...
uses
  ...
  System.Generics.Collections, System.Generics.Defaults, RADAgent.AskDialog, RADAgent.Lang;
  ...
  try
    ...
    begin
      ...
      if Entries[Index].Current then
        Line := Line + '  ' + Tr('sessions.currentTag');
      Items.Add(Line);
    end;
    if not AskChoice(Tr('sessions.switchDialogTitle'), Items, Choice) then
      Exit;
