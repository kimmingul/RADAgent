...
uses
  RADAgent.HostToolDefs, RADAgent.Approval;
...
begin
  Project := CurrentProject;
  if Project = nil then
    Exit('{"ok":false,"error":"No active project."}');
...
begin
  ...
  if (Approval = nil) or not Approval.ApproveChange(Project.FileName, '', TrF(
    'projectprofile.changeBuildConfig', [Project.CurrentConfiguration,
