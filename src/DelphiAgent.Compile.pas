...
begin
  ...
  begin
    ...
    Errors[0].Line := 0;
    Errors[0].Col := 0;
    Errors[0].Msg := #$D65C#$C131' '#$D504#$B85C#$C81D#$D2B8#$AC00' '#$C5C6#$C2B5#$B2C8#$B2E4'.';
  ...
  if Ok then
  begin
    Messages.AddToolMessage('', '빌드 성공', 'DelphiAgent', 0, 0);
    SetLength(Errors, 0);
  end
  else
  begin
    ...
    Messages.AddToolMessage(Project.FileName, '빌드 실패', 'DelphiAgent', 0, 0);
  end;
